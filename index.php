      ...
      <div class="row justify-content-center">
        <div class="col-xl-10">
          <div class="row">
            ...
            <div class="col-xl-6" style="background-color: rgb(0,0,0); background-color: rgba(0,0,0, 0.4); padding: 10px; border-radius: 10px;">
              <input type="button" class="btn btn-danger student" value="Student Login" onclick="student()" style="">
              <input type="button" class="btn btn-danger admin" value="Admin Login" onclick="admin()" style="">
