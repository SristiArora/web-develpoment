        ...
        <div class="col-xl-10">
          <div class="row">
            <div class="col-xl-5" style="background-color: rgb(0,0,0); background-color: rgba(0,0,0, 0.4); padding: 10px; border-radius: 10px;">
              ...
              <div style="margin-bottom: 10px;color: white">Admin Login</div>
              <form>
                            <div>
                              <div style="margin-bottom: 10px">
                                <input type="text" class="form-control User-ID" placeholder="Admin-ID" name="Admin_ID">
                              </div>
                              <div>
                                <input type="password" class="form-control Password" placeholder="Password" name="Admin_Password">
                              </div>
                            </div>
                            <input type="submit" value="Admin Login" class="btn btn-danger" style="margin-top: 10px;background-color: #52755b;border-color: #374f3d;">
                            <?php
                              if(isset($_REQUEST['Admin_ID']) && isset($_REQUEST['Admin_Password']))
                              {
                                    $Admin_ID=$_REQUEST['Admin_ID'];
                                    $Admin_Password=$_REQUEST['Admin_Password'];

                                    $con=mysqli_connect('localhost','root','','minor-project(Fine Alert System)');
                                    $q="select * from admin where User_ID='$Admin_ID' and Password='$Admin_Password'";
